                    ...
                    <nav class="navbar navbar-expand-lg navbar-light"><a class="navbar-brand" href="index.html"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-mortarboard-fill" viewBox="0 0 16 16">
                        ...
                        <div class="collapse navbar-collapse main-menu-item justify-content-end"
                            ...
                            <ul class="navbar-nav align-items-center">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="Addcourse.php">Add Cources</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="uploads.php">Add E-Contents</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="adviewco.php">View Courses</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="adviewcnt.php">View E-contents</a>
                                </li>
                                 <li class="nav-item">
