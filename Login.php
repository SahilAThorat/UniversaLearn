...
if(isset($_POST["btn_login"])){
    ...
    $pass = $_POST["pass"];
    if(isset($_POST["btn_login"])){
$query="SELECT * FROM sign WHERE  mail='$mail'AND pass='$pass'";
    ...
    <section class="wrapper">
      <div class="form signup">
        ...
        <form action="Login.php"method="POST">
          ...
          <a href="signup.php"class="submit1" align="center">sign up?</a>
          <a href="Adlogin.php"class="submit1" align="center">Admin Login?</a>
